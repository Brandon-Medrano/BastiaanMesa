			...
			<div id="contieneCriteriosAriba" class="contieneCriteriosAriba">
				<div id="contieneCriteriosAribaBtn" class="contieneCriteriosAribaBtn">
					<div id="PMenu" align="center">
						...
						<div id="titulo" style="margin-left:280px;" class="tituloIEC">Mesa de Atencion</div>
					</div>
				</div>
            </div>        
	     </div>
						...
						<div>
							<table style="position:relative;left:40px; text-align:left; margin-top:10px; margin-bottom:10px;">
								<tr>
									...
									<td style="padding:6px 0px 4px 10px;">		<label  style="font-family: Verdana; font-size: 10px;">Primer Nombre</label></td>
									<td style="padding:6px 0px 4px 10px;">		<input  id='primerNombreCriterioInput' type='text' style='height: 20px; width:200px;'/></input></td>	
									<td style="padding:6px 0px 4px 10px;">		<label  style="font-family: Verdana; font-size: 10px;">Segundo Nombre</label></td>
									<td style="padding:6px 0px 4px 10px;">		<input  id='segundoNombreCriterioInput' type='text' style='height: 20px; width:200px;'/></input></td>		
								</tr>
...
<!--  barra de men� para botones de la pantalla
 -->
			<div id="menuPrincipal"  align="right" class="contieneCriteriosAribaBtn" style="background-color: #6b6b6b;    height: 56px; " > 
				...
				<span id="txtTitulo" style="float:left;margin-top: 20px;margin-left: 15px;color: #FFFFFF;float: left;font-family: Verdana;font-size: 11px;font-weight: bold;">Alta de Tikect</span>
					 		...
					 		<div class="explicacionFRM" >
								<div id="filtros " class="contenedorIEC" style="overflow: auto; position: relative; width: 100%; display: block;">
								 <div style="width: 96%; display: block; height: 100%;  padding-top: 10px; padding-left: 34px;">								 	
								   <tr>
								   <table WIDHT=25%; HEIGHT=52%;  CELLPADDING=0; cellspacing="10" style="padding-top: 1px; padding-left: 1%; position:relative;display:inline-block; border: #ff6600 1px solid;">										
								 	   <td>
								   		<label style="position: relative; left: 180%; ">Solicitud</label>
								   		</td>
								   		<tr>
								    	 ...
								    	 <td>
								   		...
								   		<td>
								     		<input class="input"  type="date" id="idFormularioInput" descripcion="Id usuario" style="width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px; box-shadow: 2px 2px 5px #999;"/>
								   		</td>
								   		<td>
								     		<label style="position: relative; left: 3px; "><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Hora</font></font></label>
								   		</td>
								   		<td>
								     		<input class="input" id="aliasFormularioInput" descripcion="Password usuario" style=" width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px; box-shadow: 2px 2px 5px #999; "/>
								   		</td>
								    	...
								    	<td >
								   		...
								   		<td>						    
								    		<label style="position: relative; left: 3px; ">Proyecto</label>
								   		</td>
								   		<td>						    
								  		...
								  		<td>	
								    		<label style="position: relative; left: 3px; ">Nivel de Importancia</label>
								   		</td>
								   		...
								   		<td>	
								    		<label style="position: relative; left: 3px;  ">Area</label>
								   		</td>
								   		<td>	
								    		<input class="input" id="apellidoMaternoFormularioInput" style="width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px; box-shadow: 2px 2px 5px #999;"/>
								   		</td>
    								    <td>
    								    	<label style="position: relative; left: 3%; ">Usario a quien se asigna</label>
    								    </td>
    								     <td>
    								    	<input class="input" id="correoElectronicoPersonalFormularioInput" style="width:135px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px; box-shadow: 2px 2px 5px #999;"/>
    							  	    </td>
								     
								     <tr>
								     <td>						    
								       <label style="position: relative; left: 3px; ">Solicitante</label>
								   		</td>
								   		<td>						    
								    		<input class="input" id="segundoNombreFormularioInput" style="width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px; box-shadow: 2px 2px 5px #999;"/>
								   		</td>
								     ...
								     <td>						    
								       <label style="position: relative; left: 3px; ">Descripcion</label>
								   		...
								   		<td>						    
								    		<input class="input" id="segundoNombreFormularioInput" style="width:250px; high:220px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px; box-shadow: 2px 2px 5px #999;"/>
								   		</td>
								   </table>
								   </tr>
									</div>
