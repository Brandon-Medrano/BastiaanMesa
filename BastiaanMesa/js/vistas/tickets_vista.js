	...
	*/
	...
	{	
		...
		output += "</div>";
			...
			output += "<tr>";	
			output += "<td>";
			output += "<label style='position: relative; left: 15px'>Id Area:</label>";
			output += "</td>"
			output += "<td>";
		...
		output += "<tr>";
		output += "<td>";
		output += "<label style='position: relative; left: 15px'>Nombre Area:</label>";
			output += "</td>"
			output += "<td>"
		...
		output += "</table>";
			...
			output +=" <div id='PromptAreaGrid' class='gridPrompt' style='height:60%;width:491px;></div>";	
